...
{
    [CustomPropertyDrawer(typeof(Cel))]
    public class CelPropertyDrawer : PropertyDrawer
    {
        ...
        protected virtual IEnumerable<string> PropertiesToDraw =>
            new string[] { "_sprite", "_event" };
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            foreach (var name in PropertiesToDraw)
            {
        ...
        {
            return DrawSpritePreview(position, property, "_sprite");
        }
        ...
        protected Rect DrawSpritePreview(Rect position, SerializedProperty property, string name)
        {
            ...
            if (sprite == null || position.width < 300)
                return position;
